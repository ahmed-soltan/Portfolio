...
const Email = ({email , profileId}:{email?:string | null , profileId:string}) => {
  ...
  const isChanged = form.getValues("email") !== email;
  ...
  return (
    <div className="flex flex-col items-start gap-2 w-full border-sky-500">
      ...
      {isEditing ? (
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormControl>
                    <Input
                      placeholder='e.g. "soa548277@gmail.com"'
                      {...field}
        ...
        <h1 className="text-base text-slate-700 dark:text-slate-400 italic">You Have Not Provided a email</h1>
      )}
    </div>
  );
};
